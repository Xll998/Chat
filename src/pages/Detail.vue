<template>
  <div class="detail">
    <div class="nav">
      <ul>
        <li class="l-btn" @click="back"></li>
      </ul>
    </div>
    <div class="content">
      <div class="header clear">
        <h2>
          <img :src= detail.author_face style="border-redius: 50%; height: 1rem" />
        </h2>
        <p>作者名字</p>
      </div>
      <div class="cont">
...
export default {
  ...
  mounted(){    
    axios({
      url: 'api/home/' + this.$route.params.pathMatch
    }).then(
        res => {        
          res.data.err === 0 ? this.detail = res.data.data : null;
        }
    )
  }
}
